...
### Via CDN
```html
<script src="https://cdn.jsdelivr.net/npm/@davepagurek/p5.filterrenderer@0.0.16/p5.filterRenderer.min.js"></script>
```

On OpenProcessing, paste this link into a new library slot:
```
https://cdn.jsdelivr.net/npm/@davepagurek/p5.filterrenderer@0.0.16/p5.filterRenderer.min.js
```
